...
public class Util {
	...
	public static void createAppDir() {		
		...
		String appDir  	= extDir + Constanta.APP_DIR + "/thumbs";
		
		File fappDir  	= new File(appDir);
		
		if (!fappDir.exists()) {
			Debug.i(Constanta.TAG, "Creating application dir " + appDir);
	...
	public static String getAppDir() {
		String appDir = Environment.getExternalStorageDirectory().getPath() + Constanta.APP_DIR;
	...
	public static String getIntentName(String name) {
		return Constanta.PACKAGE_PREFIX + "." + name;
	}
