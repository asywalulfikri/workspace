package kuliketik.camera.android.stickercamera.app.camera.ui;
...
public class PhotoProcessActivity extends CameraBaseActivity {
    ...
    private void addLabel(TagItem tagItem) {
        ...
        emptyLabelView.setVisibility(View.INVISIBLE);
        if (labels.size() >= 5) {
            alert("Tips", "Anda hanya dapat menambahkan 5 tag！", "确定", null, null, null, true);
        } else {
